...
# build_js.make()
base.cmd("uglifyjs", ["./out/js/r7-office/desktop/web-apps/apps/documenteditor/main/app.js", "-o", "./out/js/r7-office/desktop/web-apps/apps/documenteditor/main/app.min.js"])
exit(0)
# exit(0)
